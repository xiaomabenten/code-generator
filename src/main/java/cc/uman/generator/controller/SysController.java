package cc.uman.generator.controller;

import cc.uman.generator.service.SysService;
import cc.uman.generator.util.PageUtils;
import cc.uman.generator.util.Query;
import cc.uman.generator.util.Response;
...
public class SysController {
    ...
    public void code(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"uoko.zip\"");
